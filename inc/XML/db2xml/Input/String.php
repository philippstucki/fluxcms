...
function addTestBefore_String($resultset)  {
    return (is_string($resultset) &&  preg_match("/<\?/",$resultset));
}

Class XML_db2xml_Input_String {

    function XML_db2xml_Input_String (&$parent)
    {
        $this->parent = $parent;
    }
    ...
    */
    ...
    {
        $this->parent->Format->InsertNewXmlString($string,$xpath);
    }
