...
class bx_errorhandler {
    ...
    private function __construct() {
        $this->excludePath = array("Cache","Date", "Config","Text".DIRECTORY_SEPARATOR."Wiki","MDB2","PEAR","Log","log.php","HTTP".DIRECTORY_SEPARATOR."WebDAV","Auth","sitemap.php","HTTP".DIRECTORY_SEPARATOR."Request","HTTP".DIRECTORY_SEPARATOR."Client", "Net","patForms","patError","XML");
