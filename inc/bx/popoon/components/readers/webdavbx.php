...
* @package  popoon
*/
class popoon_components_readers_webdavbx extends popoon_components_reader {
    ...
    */
    ...
    function start()
    {
        ...
        include_once("bx/popoon/components/readers/webdav/bx.php");
        ...
        */
        ...
        // jedit for example tries to open files with #
        // this somehow doesn't get transformed with mod_rewrite
        // so we have to add it here again..
