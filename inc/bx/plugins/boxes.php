...
<plugins>
<parameter name="xslt" type="pipeline" value="boxes.xsl"/>
<extension type="html"/>
<plugin type="boxes" >
</plugin>
...
***
* See also the boxes.xsl in your themes folder for the actual output
*/
...
class bx_plugins_boxes extends bx_plugin implements bxIplugin {
    ...
    ***/
    ...
    public function _getOverviewSections($path) {
    ...
    echo $path;
        ...
        // first tab
        $dom->addLink("Create new box",'dbforms2/boxes/');
