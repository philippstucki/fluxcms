 ...
 * @access private
 */
$GLOBALS['_Auth_OpenID_Request_Modes'] = array('checkid_setup',
                                    'checkid_immediate');

/**
 * @access private
 */
$GLOBALS['_Auth_OpenID_OpenID_Prefix'] = "openid.";

/**
 * @access private
 */
$GLOBALS['_Auth_OpenID_Encode_Kvform'] = array('kfvorm');

/**
 * @access private
 */
$GLOBALS['_Auth_OpenID_Encode_Url'] = array('URL/redirect');
