<?php
     ...
     * @access public
     */
    class HTTP_WebDAV_Server_Filesystem_MDB2 extends HTTP_WebDAV_Server 
    {
        /**
        ...
        function ServeRequest($base = false) 
        {
            ...
            /*
            removed by Bitflux, because, that's not needed here and 
            apache_request_headers is not available everywhere
            ...
            */
            ...
            if (!$this->db) {
                ...
                'password' => '',
                'hostspec' => 'localhost',
                'database' => 'webdavlocks'
                );
                $options = array(
                'debug' => 10,
                'database_path' => BX_DATA_DIR."/",
        ...
        function lock(&$options) 
        {
            ...
            if(isset($options["update"])) { // Lock Update
                $query = "UPDATE ".$prefix."locks SET expires = ".(time()+300);
            ...
            $query = "INSERT INTO ".$prefix."locks
        ...
        {
            $prefix = $GLOBALS['POOL']->config->getTablePrefix();
            $query = "DELETE FROM ".$prefix."locks
                      WHERE path = '$options[path]'
                        AND token = '$options[token]'";
            $this->db->query($query);
            
            return $this->db->affectedRows() ? "200 OK" : "409 Conflict";
        }
