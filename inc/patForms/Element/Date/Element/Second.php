<?php
/**
 * patForms Date subelement Second
 *
 * Handles seconds input and validation for the date element
 * 
 * $Id$
 *
 * @access		public
 ...
 * @author		Sebastian 'The Argh' Mordziol <argh@php-tools.net>
 */
class patForms_Element_Date_Element_Second extends patForms_Element_Date_Element
{
   /**
