...
* @package  popoon
*/
class popoon_components_generators_bxcmsadmin extends popoon_components_generator {
    ...
    */
    function DomStart(&$xml)
    {
        ...
        $xml = $collection->getInputContent($this->getParameterDefault("filename"),$this->getParameterDefault("ext"));
