<?php rcs_id('$Id: RecentChanges.php,v 1.2 2003/04/17 06:26:05 chregu Exp $');
/*
...
function popoon_RC_revision_formatter (&$fmt, &$rev) {
...
class _popoon_RecentChanges_Formatter
extends _RecentChanges_HtmlFormatter
{
    function format_revision (&$rev) {
        return popoon_RC_revision_formatter($this, $rev);
    }
...
class _popoon_PageHistory_Formatter
